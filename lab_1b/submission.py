...
def basicUnitTest():
    ...
    # test newpassword match passwordConfirmation
    ...
    assert packet7Test.newPassword != packet7Test.passwordConfirmation

    # password reset false test
